...
<div class="sub_content">
	...
	<ul>
	 ...
	 <li id="total"><img src="../images/icon/menu1.png" width=80px><br>전체</li>	 
	 <li id="hotel"><img src="../images/icon/menu2.png" width=80px><br>호텔</li>
	 <li id="pension"><img src="../images/icon/menu3.png" width=80px><br>펜션</li>
	 <li id="house"><img src="../images/icon/menu4.png" width=80px><br>하우스,집</li>
	 <li id="other"><img src="../images/icon/menu5.png" width=80px><br>기타</li>
