...
<script type="text/javascript">
	...
	//var fileIndex=element.getAttribute(${num});
		
$(function() {
	//
	/* fileIndex=(Number(fileIndex)+1); */
	var fileIndex=$('#day').val();
	fileIndex=(Number(fileIndex)+1);
	
	$("#addDay").click(function () {	
		
		var row = "<tr>";
		row +="<th width=15% class='text-top'>"+fileIndex+"일차</th>";
...
<body style="background-color: white;">
	<form id="myForm" method="post" action="../schedule/schedule_update_ok.do?id=${vo.id}"
	...
	<div  style="padding-top: 20px;">
			...
			<table class="table table-hover">
				<tbody id="my-tbody">
				<th width=15%/>
					<td width=85% class="text-center" height="20px">
					  <div>메인사진</div>
			...
			<table class="table table-hover">
				<tr>
					<td style="padding-left: 61px;" class="text-left" height="20px" colspan="2">
						<input type="text" value="${vo.hashtag }" data-role="tagsinput" placeholder="Add tags" name="hashtag"/>	
