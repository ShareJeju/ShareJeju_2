...
<div class="sub_content">
	...
	<div class="category">
	<ul>
	 <li><img src="../images/icon/menu1.png" width=80px></li>
	 <li><img src="../images/icon/menu2.png" width=80px></li>
	 <li><img src="../images/icon/menu3.png" width=80px></li>
	 <li><img src="../images/icon/menu4.png" width=80px></li>
	 <li><img src="../images/icon/menu5.png" width=80px></li>
	</ul>	
	</div>
