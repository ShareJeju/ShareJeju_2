            ...
            <form>
			   <div class="form-group">
			      ...
			      <input type="text" class="form-control" id="InputID" placeholder="ID 입력">
   			    ...
   			    <div class="form-group">
			      <label>기존 비밀번호</label>
			      <input type="password" class="form-control" id="InputPassword" placeholder="기존 비밀번호 입력">
			    </div>
			    <div class="form-group">
			      <label>새 비밀번호</label>
			      <input type="password" class="form-control" id="InputPassword" placeholder="새 비밀번호 입력">
			    </div>
   			    <div class="form-group">
			      <label>새 비밀번호 확인</label>
			      <input type="password" class="form-control" id="InputPassword" placeholder="새 비밀번호 재입력">
			    </div>
   			    <div class="form-group">
			      <label>이름</label>
			      <input type="text" class="form-control" id="InputName" 
			      	placeholder="이름을 공백없이 입력해주세요.">
			    </div>
			    <div class="form-group">
			      <label>이메일</label>
